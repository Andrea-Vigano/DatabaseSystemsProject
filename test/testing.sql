...
CREATE TABLE Promotion (
    ...
    startDate DATE,
    endDate DATE,
    discountPercentage NUMBER(38),
    CONSTRAINT FK_PROMPRO FOREIGN KEY (productID) REFERENCES Product(productID)
);


-- Insert into Admin table
--Commented Admins since we use Password Hashes for security , and can't share passwords in plaintext, recommend using signup functionality for testing
INSERT INTO Admin (adminID, username, passwordHash, email, phoneNumber)
VALUES ('1', 'admin', '87298cc2f31fba73181ea2a9e6ef10dce21ed95e98bdac9c4e1504ea16f486e4', 'admin@gmail.com', '321');
...
INSERT INTO Product (productID, name, description, price, brand, quantity, supplier, warehouse, review, categoryID, adminID)
VALUES ('4', 'Li-Ning Shoes', 'Li-Ning Shoes', 299.00, 'HunG him', 20, 'Feng', 'Ruzhe supplier', 4.70, '1', '1');
...
INSERT INTO OrderLineItems (orderLineItemID, price, quantity, productID, orderID)
...
-- For report, it is enough to type "generate-report" in the command line of the system. It will generate the table itself

-- Insert into Promotion table
INSERT INTO Promotion (productID, productName, startDate, endDate, discountPercentage)
VALUES ('1', 'Air Force shoes', TO_DATE('2023-12-02', 'YYYY-MM-DD'), TO_DATE('2023-12-25', 'YYYY-MM-DD'), 10);

INSERT INTO Promotion (productID, productName, startDate, endDate, discountPercentage)
VALUES ('2', 'New Balance 550 shoes', TO_DATE('2023-12-28', 'YYYY-MM-DD'), TO_DATE('2023-12-30', 'YYYY-MM-DD'), 45);

INSERT INTO Promotion (productID, productName, startDate, endDate, discountPercentage)
VALUES ('3', 'Nike Dunks 50s Shoes', TO_DATE('2024-01-25', 'YYYY-MM-DD'), TO_DATE('2024-01-29', 'YYYY-MM-DD'), 5);